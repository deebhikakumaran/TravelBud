...
class TrainDetail(BaseModel):
    ...
    departure_station: Optional[str] = Field(None, description="Departure station code or name")
    arrival_station: Optional[str] = Field(None, description="Arrival station code or name")
    departure_time: Optional[str] = Field(None, description="Scheduled departure time")
    arrival_time: Optional[str] = Field(None, description="Scheduled arrival time")
    train_fare: Optional[float] = Field(None, description="Train fare")

class HotelDetail(BaseModel):
    name: str = Field(..., description="Hotel name")
    address: Optional[str] = Field(None, description="Hotel address")
    check_in_time: Optional[str] = Field(None, description="Hotel check-in time")
    check_out_time: Optional[str] = Field(None, description="Hotel check-out time")

class Attraction(BaseModel):
    image: Optional[str] = Field(None, description="Valid public URL for attraction image")
    name: str = Field(..., description="Attraction name")
    description: Optional[str] = Field(None, description="Brief description")

class LocalTip(BaseModel):
    tip: str = Field(..., description="Tip or advice about the destination so that user can plan well")
    category: Optional[str] = Field(None, description="Category of the tip")
...
class Itinerary(BaseModel):
    days: List[DayItinerary] = Field(default_factory=list, description="List of day-by-day itinerary details")
